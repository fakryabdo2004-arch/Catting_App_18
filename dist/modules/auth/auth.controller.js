...
router.patch("/send-reset-password", (0, validation_middleware_1.validation)(validators.sendForgotPasswordCode), auth_service_1.default.sendForgotCode);
router.patch("/verify-forget-password", (0, validation_middleware_1.validation)(validators.verifyForgotPassword), auth_service_1.default.verifyForgotCode);
router.patch("/reset-forget-password", (0, validation_middleware_1.validation)(validators.resetForgotPassword), auth_service_1.default.resetForgotCode);
